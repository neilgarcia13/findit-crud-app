    ...
    <div>
      ...
      <section>
        <div className="container m-auto py-6 px-6">
          ...
          <Link to="/jobs"
            className="text-neutral-900 hover:text-neutral-600 flex items-center w-1/4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-70/30 w-full gap-6">
            ...
            <main>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md text-center md:text-left">
                ...
                <div
                  ...
                  <p className="text-neutral-900 font-bold">{ job.location }</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                ...
                <h3 className="text-neutral-900 text-lg font-bold mb-2">Salary</h3>
            ...
            <aside>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="my-2 bg-neutral-200 p-2 font-bold">
